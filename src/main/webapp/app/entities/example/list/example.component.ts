...
export class ExampleComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.exampleService
      ...
      .subscribe({
        next: (res: HttpResponse<IExample[]>) => {
  ...
  trackId(_index: number, item: IExample): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IExample[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
